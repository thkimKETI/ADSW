...
def generate_linestxt_on_curvelane_val():
    ...
    for file in tqdm.tqdm(all_files):
        ...
        label_path = label_path.replace('.png', '.json')    ## jpg(curvelanes) --> png(springcloud)
        ...
        culane_style_label_store_path = os.path.join(curvelane_val_root, file).replace('png','lines.txt')
